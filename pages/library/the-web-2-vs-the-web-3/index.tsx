...
const Web2AndWeb3 = () => {
  return (
    <Card>
      <p>
        If we assume that the WWW revolutionized information, and that the Web2
        revolutionized interactions, the Web3 has the potential to revo utionize
        agreements and value exchange. The Web3 changes the data structures in
        the backend of the Internet, introducing a universal state lager, often
        by incentivizing network actors with a token. The backbone of this Web3
      ...
      <p>
        ...
        we have a native value settlement laser. Thity years into miss adoption
        of the Internet, our data architectures are still based on the concept
        ...
        service provider, and every time that happens, we lose control over ou
        data. As a result, and even though we live in an increasingly connected
        world, our data is mostly centrally stored on local or remote servers,
        on our personal computers, mobile devices, flas i drives, and
        increasingly also on our watches, cars. TVs, or fridges. This raises
        issues of trust. Can I trust those people and institutions that store
      ...
      <p>
        ...
        the Internet with visually appealing and easy-to-navigate websites, Ten
        ...
        services closer together. The Web2 allowed as to en oy peer-to-peer
      ...
      <p>
        ...
        unique set of data a universal state layer that is collectively managed
        by all nodes in the network. This unique state layer, for the first
      ...
      <p>
        While the Web2 was a front-end revolution, the Web3 is a backend
        revolution. The Web3 reinvents how the Interne is wired in the backend,
        combining the system functions of the Internet with the system functions
        of computers. However, nothing much wil change on the front-end of the
        Internet for the arerage user. The Web3 represents a set of protocols,
        with distributed ledgers as their backbone. Data is collaboratively
        ...
        their activities. The protocol formalizes the gorerance rules of the
        ...
        provided by a fence and an alarm syster, the Web3 is designed in a way
        that you would need to break into multiple houses around the globe
        simultan-ously, which each have their own fence and alarm system. This
