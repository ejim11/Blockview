  ...
  return (
    <Card prev={prev} next={next}>
      ...
      <p>
        ...
        <span className="text-color-light-blue font-semibold">Consensus</span>{" "}
        in the blockchain.
      </p>
      <p className="my-[1rem]">
      ...
      <p className="mb-[1rem] mt-[2rem] font-semibold text-[2rem] text-color-dark-blue capitalize">
      ...
      <p>
        ...
        network to determine which node(computer) solved the hash problem first
        and mined the most recent block of transactions. To find a valid hash,
        we need to find a nonce value that will produce a valid hash when used
        with the rest of the information from that block.
      </p>
      ...
      <p>
        ...
        For example, having three zeros at the beginning of the hash is the
        requirement for a valid hash. The number of leading zeros required is
        the difficulty the computer problem. A miner starts a "candidate block"
        with a nonce of 0 and keep incrementing it by 1 until he finds a valid
        hash.
      </p>
      <p className="  mb-[1rem] mt-[2rem]  font-semibold text-[2rem] text-color-dark-blue capitalize">
      ...
      <div className="bg-[#f1f3f5] p-[2rem] rounded-lg mt-[2rem] sm:p-[1rem]   mb-[4rem]">
        ...
        <p>
          To give an example: In Bitcoin's genesis block, Frank sent Halley 10
          BTC. Manipulating this value from 10 BTC to 20 BTC (Maybe Halley wants
          some more BTC!) would require IMMENSE computational power as halley
          will need to rehash other blocks, recall that more blocks are still
          being mined so halley will need to also hash the current blocks mined.
        </p>
        <Image
          src={dataIntImg}
          alt="nakamoto"
