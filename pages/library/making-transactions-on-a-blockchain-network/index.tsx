...
const Transactions = () => {
  ...
  const imgClassName: string =
    "w-[70%] md:w-[80%] sm:w-[95%]  my-[4rem] mx-auto";
  ...
  return (
    <Card prev={prev} next={next}>
      ...
      <p>
        ...
        software which is a light node that connects with the ethereum network
        inorder to broadcast a transaction to the network for recording keeping
      ...
      <p className="bg-[#f1f3f5] p-[2rem] rounded-lg my-[2rem] border-l-4 border-color-light-blue">
        ...
        <Link href={"/explorer"} className="text-color-light-blue capitalize">
          explorer
        </Link>{" "}
      ...
      <p className="bg-[#f1f3f5] p-[2rem] rounded-lg my-[2rem] border-l-4 border-color-light-blue">
        ...
        in a unit called <span className="text-color-light-blue">Gas</span>.{" "}
      </p>
      <p>
