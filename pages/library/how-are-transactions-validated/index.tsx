...
const TransactionValidation = () => {
  ...
  return (
    <Card prev={prev} next={next}>
      ...
      <p>
        After a transaction is made and broadcasted the the network, It goes a
        temporary store known as the{" "}
        <span className="text-color-light-blue">Mempool</span>. In here,
        Validators verify pending transactions and add them to a new block
