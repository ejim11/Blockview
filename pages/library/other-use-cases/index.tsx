  ...
  return (
    <Card prev={prev} next={undefined}>
      ...
      <p className="my-[1rem]">
        ...
        who easy to fall to bribery to corrupt the system.
      </p>
      ...
      <p className="bg-[#f1f3f5] p-[2rem] rounded-lg my-[2rem] border-l-4 border-color-light-blue">
        A startup company in Nigeria is making use of this technology to enable
        upload, storage and easy verification of personal documents. These
        documents are minted as Nfts that are stored on the blockchain thereby
        making them accessible to anyone in the world for verification. You can
        learn more about them at{" "}
        <a
          href="https://techan-a45c8.web.app"
          target="blank"
      ...
      <p className="bg-[#f1f3f5] p-[2rem] rounded-lg my-[2rem] border-l-4 border-color-light-blue">
        I (Ejim Favour) built a decentralized escrow application that can
